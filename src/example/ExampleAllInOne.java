...
//		System.out.println("aioCheckOutWebATM: " + genAioCheckOutWebATM());
	...
	public static String genAioCheckOutOneTime(String merchantTradeNo, String merchantTradeDate, String totalAmount, String tradeDesc, String itemName, String needExtraPaidInfo){
		AioCheckOutOneTime obj = new AioCheckOutOneTime();
		obj.setMerchantTradeNo(merchantTradeNo); // 訂單編號
		obj.setMerchantTradeDate(merchantTradeDate); // 購買日期
		obj.setTotalAmount(totalAmount); // 金額
		obj.setTradeDesc(tradeDesc); // 交易描述 null
		obj.setItemName(itemName); // 商品名稱
		obj.setReturnURL("http://211.23.128.214:5000"); // 付款完成路徑
		obj.setNeedExtraPaidInfo(needExtraPaidInfo); // 是否需要額外的付款資訊
		// obj.setRedeem("Y");
		String form = all.aioCheckOut(obj, null);
		return form;
	}
