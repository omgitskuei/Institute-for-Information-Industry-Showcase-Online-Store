...
//			GetCode gen = new GetCode(30, true, true, false);		
//			String fileName = gen.generateCode();
//			String filePath = request.getSession().getServletContext().getRealPath("/WEB-INF/resources/images/");
//			String fileExt;
...
//			String presetPic = "/images/preset.png";
//			return presetPic;
//		}
//
//	}
