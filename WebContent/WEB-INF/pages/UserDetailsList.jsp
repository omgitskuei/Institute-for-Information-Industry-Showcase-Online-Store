...
<%-- 								<a href="orderDetails/updateForm?orderID=${orderInfo.orderID}" --%>
<!-- 								   class="btn btn-secondary"><i -->
<!-- 								   class="fas fa-angle-double-right"></i>新增明細</a> -->
							</jstl:forEach>
						</div>
						<table class="table table-striped">
							...
							<tbody>
								...
								<tr>
									<td align="right" rowspan="3" colspan="5"><b>總金額<fmt:formatNumber
												value="${subtotal}" pattern="#,###,###" />元
									</b></td>
								</tr>
							</tbody>
						</table>
